...
public class Edit extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
     ...
     progile_edit=(ImageView)findViewById(R.id.imageView);
     ...
     progile_edit.setOnClickListener(new View.OnClickListener() {
                                      @Override
                                      public void onClick(View v) {
        ...
        Intent w=getIntent();
        String regno2=w.getStringExtra("regnumber");

        ConnectDatabase db=new ConnectDatabase(this);
        Cursor data = db.getItemId(regno2);
        ...
        else
        {
            ...
            {
               byte[] my_image=data.getBlob(1);
              Bitmap bitmap= BitmapFactory.decodeByteArray(my_image,0,my_image.length);
              progile_edit.setImageBitmap(bitmap);
               regno.setText(data.getString(2));
                name.setText(data.getString(3));
                fname.setText(data.getString(4));
                mname.setText(data.getString(5));
                birthday.setText(data.getString(6));


                List<String> Scountry=new ArrayList<String>();
                Scountry.add(data.getString(7));
                ...
                Scountry_code.add(data.getString(8));
                ...
                phoneno.setText(data.getString(9));
                email.setText(data.getString(10));
                state.setText(data.getString(11));
                city.setText(data.getString(12));
                address.setText(data.getString(13));

                List<String> Scourse=new ArrayList<String>();
                Scourse.add(data.getString(14));
             Scourse.add("B.Tech");
             Scourse.add("B.Arch");
             Scourse.add("B.com");
             Scourse.add("B.Des");
        ...
        save.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v) {
               byte[] NewEntryImg=imageViewTobyte(progile_edit);
             ...
             else if(regno.length() !=0 && name.length() !=0 && fname.length() !=0 && mname.length() !=0 && birthday.length() !=0  && phoneno.length() !=0 && p.length()>=4 || p.length()<=12 && email.length() !=0 && Patterns.EMAIL_ADDRESS.matcher(e).matches() && state.length() !=0 && city.length() !=0 && address.length() !=0)
             {

              ConnectDatabase db = new ConnectDatabase(Edit.this);
              long l = db.update_db(NewEntryImg,r, n, fn, mn, b,co,co_code,p,e,s,c,a,cour,sp);

              if (l == -1) {
               Toast.makeText(Edit.this, "Student Details is Not Edited!! please Try again", Toast.LENGTH_LONG).show();
              } else {
               Toast.makeText(Edit.this, "Student Details Edited Successfully", Toast.LENGTH_LONG).show();
               Intent go_to_mainactivity=new Intent(Edit.this,MainActivity.class);
